################################################################################
# Nasdaq and Cryptocurrency Recursive SV-ADF Date Stamps
#
# Replication code for Figures 9 and 10 of:
# "Is There an AI Bubble? Robust Date-Stamping for Periods of Exuberance"
#
# Figure 9:
#   Recursive SV-ADF statistics and Nasdaq index values for:
#     - Recent AI-era period: 2020--2026
#     - Historical dot-com benchmark period: 1982--2012
#
# Figure 10:
#   Recursive SV-ADF statistics and prices for:
#     - Bitcoin
#     - Ethereum
#
# Data source:
...
# - Set SAVE_FIGURES <- TRUE to save the combined figures.
# - PDF files are suitable for the paper.
...
# This is used to print an interpretable summary in the console.
...
plot_bubble_episodes_horizontal <- function(
  ...
  if (!is.na(orig_idx)) {
    ...
    # Collapse after bridge: log(ns) screen plus R-run below log(ns)/2.
