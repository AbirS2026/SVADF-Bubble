...
# --------- Add stock names and keep x-axis rules ---------
# Left column: keep quarterly marks as they already are
# --------- Add stock names and make x-axis monthly ---------
...
# Right column: make x-axis half-yearly
...
# Left side top-to-bottom: Alphabet, Meta, Tesla
left_col <- arrangeGrob(
  grobs = list(p_goog, p_meta, p_tsla),
  ncol = 1
)

# Right side top-to-bottom: Apple, MSFT, Amazon
...
# pdf("six_stock_bubbles_tech.pdf", width = 16, height = 20)
# grid.newpage()
...
# grid.newpage()
# grid.draw(final_plot)
# pdf("six_stock_bubbles_tech.pdf", width = 16, height = 12)
# grid.newpage()
# grid.draw(final_plot)
# dev.off()
# ##################################################################################